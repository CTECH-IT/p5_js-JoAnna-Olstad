...
function draw() {
  ...
  //red stripes
  rect(0, 1100, windowWidth, 50);
  fill(255, 0, 0)
  rect(0, 900, windowWidth, 50);
  fill(255, 0, 0)
  rect(0, 800, windowWidth, 50);
  fill(255, 0, 0)
  ...
  textWrap(CHAR);
  textWrap(WORD);
  text('"I pledge allegiance to the Flag of the United States of America, and to the Republic for which it stands, one Nation under God, indivisible, with liberty and justice for all."', 0, 100, 550);
